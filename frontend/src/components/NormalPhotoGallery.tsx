...
const NormalPhotoGallery = forwardRef<HTMLDivElement>((props, ref: ForwardedRef<HTMLDivElement>) => {
  const photos: Photo[] = [
    {
        ...
        <div className={styles["gallery-rows"]}>
          {photoRows.map((row, rowIndex) => (
            <div key={rowIndex} className={styles["photo-row"]}>
              {row.map((photo, index) => (
                <div key={`${rowIndex}-${index}`} className={styles["photo-item"]}>
                  <img
                    src={photo.url}
                  ...
                  {photo.caption && (
                    <div className={styles["photo-caption"]}>
                      <span className={styles["caption-text"]}>{photo.caption}</span>
                    </div>
                  )}
                </div>
              ))}
